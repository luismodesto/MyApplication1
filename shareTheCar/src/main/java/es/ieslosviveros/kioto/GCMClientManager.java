...
public class GCMClientManager {
    ...
    public static final String PROPERTY_REG_ID = "reg_id";//U"; //498610966391
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                try {
                    ...
                    Log.i(TAG,projectNumber+" Obtenida -------------- "+ regid);
                    ...
                    handler.onFailure("Error  de registro :" + ex.getMessage());
                }
                return regid;
            }
            @Override
